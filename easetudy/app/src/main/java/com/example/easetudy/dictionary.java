...
import com.example.easetudy.Adapters.MeaningAdapter;
import com.example.easetudy.Adapters.PhoneticsAdapter;
import com.example.easetudy.Models.APIResponse;
import com.example.easetudy.Models.RequestManager;
...
public class dictionary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        RequestManager manager = new RequestManager(dictionary.this);
    ...
    private final OnFetchDataListener listener = new OnFetchDataListener() {
        @Override
        public void onFechData(APIResponse apiResponse, String message) {
